...
function_declared: FUNC ID (interface_parameter_container) (mytype)? (function_body_container) SEMICOLON;
    function_body_container: LBRACE list_statement_prime RBRACE;

method_declared: FUNC (receiver_container) ID (interface_parameter_container) (mytype)? (function_body_container) SEMICOLON;
